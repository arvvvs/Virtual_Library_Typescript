...
var LibrarySearch = (function () {
    ...
    */
    LibrarySearch.prototype.filterBy = function (attr_case, attr_name_case, type_case) {
    ...
    */
    LibrarySearch.prototype.borrow = function (attr_case, attr_name_case, type_case) {
        if (type_case === void 0) { type_case = "all"; }
